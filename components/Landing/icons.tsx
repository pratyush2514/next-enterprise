...
/** Music note placeholder — used in AppPreview poster & mini player */
export function MusicNotePlaceholderIcon({ className }: { className?: string }) {
  return (
    <svg
      xmlns="http://www.w3.org/2000/svg"
      fill="none"
...
/** Melodix logo icon — used in AppPreview sidebar */
export function MelodixLogoIcon() {
  return (
...
/** Queue icon — used in AppPreview mini player */
...
/** Pause icon — used in AppPreview mini player */
...
/** Skip next icon — used in AppPreview mini player */
...
/** More menu icon — used in AppPreview mini player */
...
/** Apple icon — used in Footer App Store badge */
...
/** Close (X) icon — mobile menu dismiss */
