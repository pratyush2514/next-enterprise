...
const gradients = {
  ...
  rimLeft:
    "linear-gradient(180deg, transparent 0%, rgba(74, 222, 128, 0.8) 20%, rgba(74, 222, 128, 1) 50%, rgba(74, 222, 128, 0.8) 80%, transparent 100%)",
  rimRight:
    "linear-gradient(180deg, transparent 0%, rgba(13, 148, 136, 0.7) 20%, rgba(13, 148, 136, 0.9) 50%, rgba(13, 148, 136, 0.7) 80%, transparent 100%)",
}
```
